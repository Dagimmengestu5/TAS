                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <Link to="/profile" className="flex items-center gap-4 hover:bg-gray-50 p-2 px-3 rounded-2xl transition-all duration-300 group">
                                <div className="flex flex-col items-end">
                                    ...
                                    <span className="text-xs font-semibold text-brand-yellow uppercase tracking-wider">{user?.role?.name}</span>
                                </div>
                                <div className="w-10 h-10 bg-gray-900 text-brand-yellow rounded-xl flex items-center justify-center font-bold text-sm uppercase shadow-lg border border-gray-800 relative transition-transform group-hover:scale-105">
                                    {user?.name?.charAt(0)}
                                </div>
                            </Link>
                        </div>
