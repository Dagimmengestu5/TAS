...
import { CheckCircle, XCircle, Building2, User, Download, FileText, ShieldCheck, Clock } from 'lucide-react';
        ...
        <div className="bg-gray-50 min-h-screen w-full selection:bg-brand-yellow/30 px-6 py-8 lg:px-12 font-['Outfit']">
            <div className="mb-12 flex justify-between items-end">
                <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h1 className="text-4xl font-black text-gray-900 uppercase tracking-tighter italic leading-none">HR Approver Hub</h1>
                    </div>
                    <p className="text-[11px] font-bold text-gray-400 uppercase tracking-[0.3em] italic ml-14">
                        Pending Requisitions • Budget & Compliance Review
                    </p>
                </div>
            </div>
            ...
            {loading ? (
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center py-32 bg-white rounded-3xl border border-gray-100 flex flex-col items-center shadow-sm">
                    ...
                    <p className="text-gray-400 font-bold uppercase text-[10px] tracking-widest italic px-6 max-w-md">There are no pending job requisitions requiring HR authorization at this time.</p>
                </motion.div>
            ) : (
                            ...
                            >
                                ...
                                <div className="flex justify-between items-start mb-6">
                                    ...
                                    <div className="flex flex-col items-end gap-1.5">
                                        <span className="px-3 py-1 rounded-md text-[9px] font-black uppercase tracking-widest border border-amber-200 bg-amber-50 text-amber-600 italic flex items-center gap-1">
