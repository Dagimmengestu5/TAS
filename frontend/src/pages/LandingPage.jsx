...
import { Search, MapPin, Clock, Filter, Briefcase, ChevronRight, CheckCircle, Users, Mail, ArrowRight, Zap, Globe, Shield, Building2, X, Star, Cpu, Activity, LogOut, Linkedin, Twitter, Facebook, Phone, GraduationCap, Award } from 'lucide-react';
        ...
        <div className="min-h-screen bg-white  text-gray-900 selection:bg-brand-yellow/30">
                    ...
                    <div className="max-w-[1600px] mx-auto h-24 flex items-center justify-between">
                        <div className="flex items-center gap-3 cursor-pointer group" onClick={() => navigate('/')}>
                            ...
                            <div className="flex flex-col">
                                <span className="text-lg font-bold tracking-tight text-gray-900 leading-none uppercase ">Droga Hub</span>
                        ...
                        >
                            <div className="flex flex-col items-start gap-2 min-w-[120px]">
                                <label className="flex items-center gap-2 text-[9px] font-bold text-gray-400 uppercase tracking-wider ">
                                    <Briefcase className="w-3.5 h-3.5 text-brand-yellow" /> Job Type
                                </label>
                                <select
                                    className="bg-transparent border-none p-0 text-[11px] font-bold text-gray-900 focus:ring-0 cursor-pointer hover:text-brand-yellow transition-colors uppercase tracking-wider"
                                    value={typeFilter}
                            ...
                            <div className="flex flex-col items-start gap-2 min-w-[120px]">
                                <label className="flex items-center gap-2 text-[9px] font-bold text-gray-400 uppercase tracking-wider ">
                                    <Zap className="w-3.5 h-3.5 text-brand-yellow" /> Expertise
                                </label>
                                <select
                                    className="bg-transparent border-none p-0 text-[11px] font-bold text-gray-900 focus:ring-0 cursor-pointer hover:text-brand-yellow transition-colors uppercase tracking-wider"
                                    value={tagFilter}
                            ...
                            <div className="flex flex-col items-start gap-2 min-w-[120px]">
                                <label className="flex items-center gap-2 text-[9px] font-bold text-gray-400 uppercase tracking-wider ">
                                    <GraduationCap className="w-3.5 h-3.5 text-brand-yellow" /> Education
                                </label>
                                <select
                                    className="bg-transparent border-none p-0 text-[11px] font-bold text-gray-900 focus:ring-0 cursor-pointer hover:text-brand-yellow transition-colors uppercase tracking-wider"
                            ...
                            <div className="flex flex-col items-start gap-2 min-w-[120px]">
                                <label className="flex items-center gap-2 text-[9px] font-bold text-gray-400 uppercase tracking-wider ">
                                    <Award className="w-3.5 h-3.5 text-brand-yellow" /> Experience
                                </label>
                                <select
                                    className="bg-transparent border-none p-0 text-[11px] font-bold text-gray-900 focus:ring-0 cursor-pointer hover:text-brand-yellow transition-colors uppercase tracking-wider"
            ...
            {user?.role?.name !== 'admin' && (
                <motion.footer
                    ...
                    variants={staggerContainer}
                    className="bg-gray-900 text-white pt-20 pb-10 border-t border-gray-800 relative z-10 w-full "
                >
                    {/* Top Gloss Effect */}
                    ...
                    <div className="max-w-7xl mx-auto px-6 lg:px-12">
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16">
                            ...
                            <motion.div variants={fadeInUp} className="lg:col-span-4 space-y-6">
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-gray-900 font-bold text-2xl shadow-[0_0_20px_rgba(255,255,255,0.1)]">D</div>
                                    <div className="flex flex-col">
                                        <span className="text-xl font-bold tracking-tight uppercase leading-none">Droga Group</span>
                                        <span className="text-[9px] font-bold text-brand-yellow uppercase tracking-wider leading-tight">Industrial Evolution</span>
                                    </div>
                                </div>
                            ...
                            {/* Links Grid */}
                            <motion.div variants={fadeInUp} className="lg:col-span-4 grid grid-cols-2 gap-8">
                                {sections.map((section, idx) => (
                                    <div key={idx} className="space-y-6">
                                        <h4 className="text-xs font-bold uppercase tracking-wider text-brand-yellow">{section.title}</h4>
                            ...
                            {/* Contact & Support */}
                            <motion.div variants={fadeInUp} className="lg:col-span-4 space-y-6 bg-gray-800/30 p-8 rounded-3xl border border-gray-700/30 backdrop-blur-sm">
                                <h4 className="text-xs font-bold uppercase tracking-wider text-brand-yellow">Access Points</h4>
                                ...
                                <button className="w-full py-4 bg-brand-yellow text-gray-900 rounded-2xl font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 hover:bg-white transition-all active:scale-95 shadow-lg shadow-brand-yellow/10">
                        ...
                        {/* Bottom Bar */}
                        <motion.div variants={fadeInUp} className="pt-8 border-t border-gray-800/50 flex flex-col md:flex-row items-center justify-between gap-6">
                            ...
                            <div className="flex items-center gap-6">
                                <a href="#" className="text-gray-500 hover:text-white text-[10px] font-bold uppercase transition-colors tracking-wider leading-none">Privacy_Layer</a>
                                <a href="#" className="text-gray-500 hover:text-white text-[10px] font-bold uppercase transition-colors tracking-wider leading-none">Security_Audit</a>
                            </div>
                        </motion.div>
                    </div>
                </motion.footer>
